...
export function CoverPage({ onEnter }: CoverPageProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex flex-col items-center justify-center px-6 animate-slide-up">
      <div className="max-w-4xl mx-auto text-center space-y-8">
        <div className="flex justify-center mb-4">
          <div className="relative">
            <div className="absolute inset-0 bg-green-400 blur-3xl opacity-20 rounded-full"></div>
            <div className="relative bg-white p-6 rounded-full shadow-lg">
              <FFBLogo className="text-green-600" size={64} />
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-green-100">
            <div className="flex justify-center mb-4">
              <FFBLogo className="text-green-600" size={40} />
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-gray-500">
            Odroid • Computer Vision • Machine Learning
          </p>
        </div>
      </div>
    </div>
